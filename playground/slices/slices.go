...
func main() {
	...
	fmt.Printf(comparePointers("Array", "Head Slice", &startingSlice[0], &headSlice[0]))
	fmt.Println()
	...
	fmt.Printf(comparePointers("Array", "Tail Slice", &startingSlice[len(startingSlice)-1], &tailSlice[len(tailSlice)-1]))
